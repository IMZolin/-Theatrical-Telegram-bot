...
def pars():
    pd.read_json("all_performance_dict.json", lines=True).to_excel("performance_list.xlsx")
...
for performance in performances:
    ...
    if(performance_name and performance_min_discription and performance_theatre and performance_rating and performance_urls and performance_price):
...
with open("all_performance_dict.json", "r", encoding='utf-8') as file:
    pd.read_json('all_performance_dict.json', lines=True, orient='records')
    #pd.read_json("all_performance_dict.json", lines=True, orient='records').to_excel("performance_list.xlsx")
